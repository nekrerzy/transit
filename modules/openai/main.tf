# AzAPI provider requirement temporarily removed (no NSP configuration)
...
# Note: NSP configuration temporarily removed for simplified deployment
# Will add back once basic OpenAI deployment is confirmed working